...
##   ext[4] (D22) = FPGA UART TX -> screen RX, optional
## AFSK DAC output mapping:
##   da1_out[13:0], da1_clk, da1_wrt = DAC channel 1 output

set_property BITSTREAM.CONFIG.SPI_BUSWIDTH 4 [current_design]
set_property CONFIG_MODE SPIx4 [current_design]
set_property BITSTREAM.CONFIG.CONFIGRATE 50 [current_design]

## Do not enable CLOCK_DEDICATED_ROUTE FALSE unless your board clock route really needs it.
## set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {clk_100m_in_IBUF}]

create_clock -period 10.000 -name sys_clk [get_ports clk_100m_in]
set_property -dict {PACKAGE_PIN C19 IOSTANDARD LVCMOS33} [get_ports clk_100m_in]
