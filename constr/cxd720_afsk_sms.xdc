...
create_clock -period 10.000 -name clk_100m_in [get_ports clk_100m_in]
...
# Extended 40 IO Pins. ext[3] is UART RX from serial screen TXD; ext[4] is UART TX to serial screen RXD.
